...
public class DroneController {
    ...
    private final ConcurrentMap<ActionCommand, Long> actionDuration = Maps.newConcurrentMap();
        ...
        updateTimer.scheduleAtFixedRate(new TimerTask(){
            ...
            public void run() {
                for (ActionCommand a: actionDuration.keySet()) {
                    final long current = actionDuration.get(a);
                    final long remaining = Math.max(0, current - UPDATE_PERIOD_MS);
